...
def health():
    ...
    return jsonify({"status": "ok", "message": "Task API is healthy and pls navigate to api/auth/register or api/auth/login. Readme File --> https://github.com/Prashant5ingh/Flask_API_Project_List/blob/main/README.md"}), 200
